...
@click.option(
    ...
    default='[]',
    required=True,
    help='Security group ids - Syntax: \'["sg-123456","sg-123456"]\''
)
@click.option(
    '--iam_instance_role',
    type=str,
...
## NOTE: Please use at your own discretion. Not responsible for any damage or accidental deletion of AWS infrastructure."""
    ...
    oceanid = create_ocean(account_id=kwargs.get('account_id'), token=kwargs.get('token'),
                           ...
                           subnet_id=kwargs.get('subnet_id'), ecs_ami_id=kwargs.get('ecs_ami'), sg_id=sg_id,
...
#########################################
def create_ocean(account_id, token, ecs_cluster, region, subnet_id, ecs_ami_id, sg_id, iam_instance_role):
    ocean_exist = False
