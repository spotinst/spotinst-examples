...
try:
    GroupId=client.create_security_group(Description=securityGroup_description,GroupName=securityGroupName,VpcId=vpcId,DryRun=False)
    ...
    if e.response['Error']['Code'] == 'InvalidGroup.Duplicate':
        ...
        try:
            GroupId=client.describe_security_groups(Filters=[{'Name':'group-name','Values':[securityGroupName]},{'Name':'vpc-id','Values':[vpcId]}])
