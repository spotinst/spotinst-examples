...
In this example we will demonstarte how to run Redis cluster slaves on Spotinst using terraform while leveraging Spotinst Stateful features in order to keep the cluster available.
...
* This terrafom template will crate Stateful Elastigroup with persisting the private IP and Data and root volume.
